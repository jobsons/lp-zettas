  ...
  return (
    <>
      ...
      <section id="diferenciais" className="py-16 md:py-24 bg-transparent scroll-mt-24 relative">
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-navy-900/20 via-transparent to-transparent pointer-events-none"></div>
            ...
            {techStack.map((tech, index) => {
              ...
              return (
                <motion.div
                  ...
                  className="bg-navy-900/80 backdrop-blur-sm p-8 rounded-2xl shadow-md border border-navy-800 hover:border-cyan-500/20 transition-colors group relative overflow-hidden"
                >
            ...
            {methodology.map((item, index) => {
              ...
              return (
                ...
                >
                  ...
                  <div className="w-24 h-24 bg-navy-800/50 backdrop-blur-sm border border-navy-700 rounded-2xl flex items-center justify-center mb-6 relative z-10 group-hover:border-cyan-500/60 transition-all shadow-md group-hover:shadow-lg">
                    <Icon className="w-10 h-10 text-cyan-400" />
                    <div className="absolute -top-2 -right-2 bg-cyan-600 text-white text-xs font-bold w-8 h-8 rounded-xl flex items-center justify-center">
                      {item.step}
                    </div>
                  </div>
